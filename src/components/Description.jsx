  ...
  return (
    <div className="mt-16">
      <div className="flex text-center font-medium md:w-[30%]">
        ...
        <div className="flex-1 border border-b-0 px-4 py-3 bg-gray-50">Reviews (122)</div>
      </div>
      <div className="border p-6 pb-8 md:p-8 md:pb-10 leading-7">
        <p className="mb-4">
          ...
          totam sit eaque facilis, distinctio porro amet iste. Lorem ipsum dolor sit amet consectetur adipisicing elit. Non cumque
